...
<div class="container"> <div class="row justify-content-center"> <div class="col-md-8"> <div class="card enhanced-card"> <div class="card-header"> <h4>Add New Subject</h4> </div>
text
            <div class="card-body">
                <form method="POST" action="{{ route('subjects.store') }}" class="enhanced-form">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="classes[]" value="{{ $class->id }}" id="class{{ $class->id }}" {{ in_array($class->id, old('classes', [])) ? 'checked' : '' }}>
